...
# pyrefly: ignore [missing-import]
from src.metrics import evaluate_query_retrieval
# pyrefly: ignore [missing-import]
from src.retriever import AdvancedRAGRetriever
# pyrefly: ignore [missing-import]
...
class RAGSearch:
    ...
    def __init__(self, persist_dir: str = "chroma_store", embedding_model: str = "all-MiniLM-L6-v2", llm_model: str = "llama-3.3-70b-versatile"):
        ...
        self.vectorstore = self.advanced_retriever.vector_store
        self.hybrid_retriever = self.advanced_retriever.hybrid_retriever
        ...
        self.prompt_template = ChatPromptTemplate.from_messages([
            ("system",
             ...
             You have contexts of various documents having description regarding various courses across different branches of Engineering and a retrieval evaluation report. 
    ...
    def search_and_summarize(self, query: str, top_k: int = 5) -> dict:
        ...
        # 1. Retrieve relevant context using Advanced RAG Retriever
        retrieved_docs = self.advanced_retriever.retrieve(query, top_k=top_k, alpha=0.5)
